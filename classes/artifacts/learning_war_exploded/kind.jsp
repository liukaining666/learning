            ...
            <div class="modal-content">
                ...
                <div class="row" id="addmodal" style="display: none">
                    <div class="col-lg-12">
                        ...
                        <div class="card-content">
                            <form class="col s12" action="<%=Const.ROOT%>kind/addKind" method="post"
            ...
            <div class="modal-content">
                ...
                <div class="row" id="updatemodal" style="display: none">
                    <div class="col-lg-12">
                        ...
                        <div class="card-content">
                            <form class="col s12" action="<%=Const.ROOT%>kind/updateKind" method="post"
                                  enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="row" id="deletemodal" style="display: none">
                    <div class="col-lg-12">
                        ...
                        <div class="card-content">
                            <form class="col s12" action="<%=Const.ROOT%>kind/delKind" method="post"
                                  enctype="multipart/form-data">
