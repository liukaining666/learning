                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table" >
                                    ...
                                    <c:forEach items="${pageInfo.list}" var="item" varStatus="count">
                                        <tr class="info">
                                            ...
                                            <td>${item.username }</td>
                                            <td>
                                               <a class="waves-effect waves-light btn"  href="<%=Const.ROOT%>void/getMyGuanZhu?id=${item.nid}">
                            						查看</a>
                                  	 <a class="waves-effect waves-light btn" data-toggle="modal" data-target="#sixinModal" onclick="hufu(${item.nid })">
                            						私信</a>
                                ...
                                <!--分页-->
                                <form action="<%=Const.ROOT%>user/getMyGuanZhu" method="post" id="Page">
        ...
        <div class="modal-content">
           ...
           <div class="row" id="deletemodal" style="display: none">
                <div class="col-lg-12">
                        ...
                        <div class="card-content">
                         	<form class="col s12" action="<%=Const.ROOT%>user/delGuanZhu" method="post" enctype="multipart/form-data">
    ...
    <label>
      ...
      <!--私信 -->
        ...
        <div class="modal-content">
           ...
           <div class="row" id="sixinmodal" style="display: none">
                <div class="col-lg-12">
                 	
                        <div class="card-content">
                         	<form class="col s12" action="<%=Const.ROOT%>user/sixin" method="post" enctype="multipart/form-data">
                         		<input id="nid" name="nid"  type="hidden"/>	
									 <div class="row">
									<div class="input-field col s12">
									   <textarea  name="content" id="content" class="materialize-textarea"></textarea>
									  <label for="icon_prefix">私信内容</label>
									</div>
								  </div>
