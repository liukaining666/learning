    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <c:if test="${sessionScope.role==1}">
                ...
                <li style="height: 42px">
                    <a href="<%=Const.ROOT%>user/getTeacherlist" class="waves-effect waves-dark"><i
                            class="fa fa-desktop"></i> 教师管理</a>
                </li>
                <li style="height: 42px">
                ...
                <li style="height: 42px">
                    <a href="<%=Const.ROOT%>void/getziliaolist" class="waves-effect waves-dark"><i
                            class="fa fa-edit"></i> 资料管理 </a>
                </li>
                <li style="height: 42px">
                ...
                <li style="height: 42px">
                    <a href="<%=Const.ROOT%>timu/getTimulist" class="waves-effect waves-dark"><i class="fa fa-edit"></i>
                        试题管理 </a>
                </li>
                <li style="height: 42px">
                    <a href="<%=Const.ROOT%>timu/getKaoshilist" class="waves-effect waves-dark"><i
            ...
            <c:if test="${sessionScope.role==2}">
                <li class="waves-effect waves-dark">
                    <a href="/learning/studentList.jsp"><i class="fa fa-bar-chart-o"></i>
                        课堂管理
                    </a>
                </li>
                <li style="height: 42px">
            ...
            <li style="height: 42px">
                <a href="<%=Const.ROOT%>void/getziliaolist?role=3" class="waves-effect waves-dark"><i
                        class="fa fa-edit"></i> 学习资料 </a>
            </li>
            ...
            <c:if test="${sessionScope.role==3}">
                ...
                <li style="height: 42px">
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i> 我的--<span
