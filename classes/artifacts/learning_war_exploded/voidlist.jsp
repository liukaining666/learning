...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper" style="margin-top: -14px">
		  <div class="header"> 
		  <form action="<%=Const.ROOT%>void/getVoidlist" method="post">
		  <div class="row">
		  <div class="col-sm-6">
                        <h1 class="page-header">
                        	...
                        	<c:if test="${sessionScope.role==1}">
	                          	<div class="col-sm-3">
	                          		<div id="dataTables-example_filter" class="dataTables_filter">
	                          		   <label>查询:<input type="search" name="teachername" value="${teachername }" class="form-control input-sm" placeholder="请输入用户名" aria-controls="dataTables-example">
                           ...
                           <div class="col-sm-3">
                          		<div id="dataTables-example_filter" class="dataTables_filter">
                          		   <label>查询:<input type="search" name="voidname" value="${voidname }" class="form-control input-sm" placeholder="请输入视频名" aria-controls="dataTables-example">
                                ...
                                <table class="table" >
                                    ...
                                    <c:forEach items="${pageInfo.list}" var="item" varStatus="count">
									 ...
									 <a class="waves-effect waves-light btn" data-toggle="modal" data-target="#deleteModal" onclick="todelete('${item.id}')">
                            						删除</a>
                            						<c:if test="${sessionScope.role==1}">
                            							<a class="waves-effect waves-light btn" data-toggle="modal" data-target="#deleteModalT" onclick="todeleteT('${item.id}')">
                            						置顶</a>
                            						</c:if>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">发布教学视频</h4>
            </div>
            <!-- 新增 -->
                        ...
                        <div class="card-content">
                         	<form class="col s12" action="<%=Const.ROOT%>void/addVoid" method="post" enctype="multipart/form-data">
                         		<input id="role" name="role" value="1" type="hidden"/>
								  ...
								  <div class="row">
									<div class="input-field col s6">
									  ...
									  <label for="icon_prefix">视频名称</label>
							
									</div>
									<div class="input-field col s6">
									
						 				<select class="form-control"  id="kindid" name="kindid">
						 				 <option>--请选择视频课程--</option>
								...
								<div class="input-field col s12">
								  ...
								  <label for="textarea1">视频简介</label>
								</div>
							  </div>
        ...
        <div class="modal-content">
           ...
           <div class="row" id="updatemodal" style="display: none">
                <div class="col-lg-12">
                        ...
                        <div class="card-content">
                         	<form class="col s12" action="<%=Const.ROOT%>void/updateVoid" method="post" enctype="multipart/form-data">
								...
								<div class="row">
								<div class="input-field col s12">
								  <textarea  name="voidcontent" id="voidcontent" required="" class="materialize-textarea"></textarea>
								  <label for="textarea1">视频内容简介</label>
								</div>
							  </div>
        ...
        <div class="modal-content">
           ...
           <div class="row" id="deletemodal" style="display: none">
                <div class="col-lg-12">
                        ...
                        <div class="card-content">
                         	<form class="col s12" action="<%=Const.ROOT%>void/delVoid" method="post" enctype="multipart/form-data">
    ...
    <label>
       ...
       <div class="modal fade" id="deleteModalT" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="myModalLabel">置顶视频</h4>
            </div>
           <div class="row" id="deletemodalT" style="display: none">
                <div class="col-lg-12">
                 
                        <div class="card-content">
                         	<form class="col s12" action="<%=Const.ROOT%>void/zhidin" method="post" enctype="multipart/form-data">
